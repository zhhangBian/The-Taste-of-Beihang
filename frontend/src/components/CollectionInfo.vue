    ...
    <div style="padding: 10px">
      ...
      <div class="columns-container">
        <div class="left-column">
          ...
          <h2>收藏的食堂</h2>
          <el-button type="primary" @click="handleAddCanteen" style="margin-bottom: 10px">新增食堂</el-button>
          <el-table :data="pagedCanteenData" border style="width: 100%">
            <el-table-column prop="time" label="时间" />
            <el-table-column prop="canteen" label="食堂" />
            <el-table-column label="操作">
              <template #default="scope">
                <el-button link type="primary" size="small" @click="handleEditCanteen(scope.row, scope.$index)">编辑</el-button>
                <el-button link type="danger" size="small" @click.prevent="removeCanteen(scope.$index)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <div class="right-column">
          ...
          <h2>收藏的菜品</h2>
          <el-button type="primary" @click="handleAddDish" style="margin-bottom: 10px">新增菜品</el-button>
          <el-table :data="pagedDishData" border style="width: 100%">
            ...
            <el-table-column label="操作">
              <template #default="scope">
                <el-button link type="primary" size="small" @click="handleEditDish(scope.row, scope.$index)">编辑</el-button>
                <el-button link type="danger" size="small" @click.prevent="removeDish(scope.$index)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <div class="pagination-container">
