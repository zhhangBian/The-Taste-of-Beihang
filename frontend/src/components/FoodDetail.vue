    ...
    <div class="bg-white text-black">
      <div class="container">
        ...
        <div class="col-span-2">
          <img :src="dish.image" alt="Delicious dish" class="w-full h-auto rounded-lg">
        ...
        <div class="col-span-2">
          <img src="https://placehold.co/400x300" alt="Hotpot dish" class="w-full h-auto rounded-lg">
          ...
          <div class="mt-4">
            ...
            <textarea class="w-full h-32 mt-4 p-2 rounded-lg font-man resize-none" placeholder="帮助大家了解这道菜吧！" v-model="newReview.comment"></textarea>
